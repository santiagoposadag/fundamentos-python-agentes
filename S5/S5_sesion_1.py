...
if __name__ == "__main__":
    ...
    # CONCLUSION: No se persite nada porque no existe un lugar donde guardar los datos. Necesitamos una memoria permanente: una base de datos.
    ...
    # CONCLUSION: No es del todo legible porque es archivo binario pero se puede  observar medianemtne que lo que contiene es la creación de la base de datos.
    ...
    # CONCLUSION: [DB] Error: El agente 'Atlas' ya existe en la base de datos.
    ...
    # CONCLUSION: Si Atlas sigue vivo. Los datos persisten en el archivo agentes.db en disco por lo que sobreviven al cierre de Python
    ...
    # CONCLUSION: Si funciona. La tabla mensajes no tiene restriccion que impida que remitente y destinatario sean el mismo agente.
    ...
    # CONCLUSION: leer_mensajes filtra por destinatario con WHERE, por lo que cada agente  tiene su propia bandeja independiente. 
    ...
    # CONCLUSION:Si tanto los mensajes como los agentes persisten tras cerrar Python.
